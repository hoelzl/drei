...
5. Before claiming or starting any slice, run `scripts/sync-check.sh` and follow the claim protocol in `docs/agent/claims.md` (slice issue first, plan PR second). Write the plan from `docs/agent/plan-template.md`, acceptance scenario first.
